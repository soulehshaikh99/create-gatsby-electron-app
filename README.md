...
```bash
# Clone the Project
$ gh repo clone https://github.com/soulehshaikh99/create-gatsby-electron-app.git # or git clone https://github.com/soulehshaikh99/create-gatsby-electron-app.git
